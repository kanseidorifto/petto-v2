...
namespace petto_backend_net.DAL.Migrations
{
    ...
    [Migration("20240619072340_RefactorChats")]
    partial class RefactorChats
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("petto_backend_net.DAL.Entities.ChatMessage", b =>
                {
                    ...
                    b.Property<string>("MessageMediaUrls")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("petto_backend_net.DAL.Entities.ChatParticipant", b =>
                {
                    ...
                    b.Property<Guid?>("LastReadedMessageId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("petto_backend_net.DAL.Entities.ChatParticipant", b =>
                {
                    ...
                    b.HasOne("petto_backend_net.DAL.Entities.ChatMessage", "LastReadedMessage")
                        .WithMany("LastReadedBy")
                        .HasForeignKey("LastReadedMessageId");

                    b.HasOne("petto_backend_net.DAL.Entities.UserProfile", "Profile")
                        .WithMany("ChatsParticipations")
                    ...
                    b.Navigation("LastReadedMessage");
            ...
            modelBuilder.Entity("petto_backend_net.DAL.Entities.UserProfile", b =>
                {
                    b.HasOne("petto_backend_net.DAL.Entities.Community", null)
                        .WithMany("Members")
                        .HasForeignKey("CommunityId");
                });
            ...
            modelBuilder.Entity("petto_backend_net.DAL.Entities.UserProfile", b =>
                {
                    ...
                    b.Navigation("ChatsParticipations");
